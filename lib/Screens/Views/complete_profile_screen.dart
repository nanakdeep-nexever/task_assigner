                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      context.read<ProfileBloc>().add(UpdateProfile(
                            ...
                            profileImage: (context.read<ProfileBloc>().state
                                    as ProfileImagePicked?)
                                ?.profileImage,
                          ));
                      ...
                      } else if (UserRoleManager().currentRole == "developer") {
                        Navigator.pushNamed(context, "/developer");
                      } else if (UserRoleManager().currentRole == "manager") {
                        Navigator.pushNamed(context, "/manager");
                      } else if (UserRoleManager().currentRole == "viewer") {
