...
class NotificationHandler {
  ...
  NotificationHandler(this._flutterLocalNotificationsPlugin);
  ...
  static Future<String> _getAccessToken() async {
    final serviceAccountJson = await _fetchServiceAccountJson();
  ...
  static Future<String> _fetchServiceAccountJson() async {
    // Replace with secure fetching mechanism
    return r'''
     {
